export function lbHeroComposition(): angular.IDirective {
    return {
        ...
        template: `
			...
			<div ng-if="!video" style="height:240px;min-height:240px;background-image:url(/images/sheet-music.jpg);background-size:cover;background-repeat:no-repeat;background-position:center center;"></div>
		`,
        scope: {
            video: '='
        }
